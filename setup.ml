...
(* OASIS_START *)
(* DO NOT EDIT (digest: c46d2520c32278bbdac30f985c519081) *)
(*
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Text reflowing for terminal applications";
          description = None;
          categories = [];
            ...
            [
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("extunix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["ptyutils_stub.c"];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "reflow.ml"; })
            ];
          plugins = [];
